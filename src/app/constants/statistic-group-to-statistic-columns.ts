...
const standardPitchingStatisticColumns: string[] = ['W', 'L', 'ERA', 'G', 'GS', 'CG', 'SHO', 'SV', 'SVO', 'IP', 'H', 'R', 'ER', 'HR', 'HB', 'BB', 'SO', 'AB', 'WHIP', 'AVG'];
const advancedPitchingStatisticColumns: string[] = ['TBF', 'NP', 'P/IP', 'QS', 'GF', 'HLD', 'IBB', 'WP', 'BK', 'SF', 'GDP', 'GO', 'AO', 'GO/AO', 'SO/9', 'BB/9', 'K/BB', 'BABIP', 'SB', 'CS', 'PK'];
