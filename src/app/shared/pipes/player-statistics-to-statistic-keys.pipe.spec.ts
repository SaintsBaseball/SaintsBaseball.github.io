  ...
  describe('transform', () => {
    ...
    it('should transform a populated table to an empty string array when an invalid season name is passed in', () => {
      ...
      statistics["Spring 2019"] = [
        {
          "#": 3, "Player": "my bro", "G": 17, "AB": 63, "R": 9, "H": 19, "2B": 1, "3B": 0, "HR": 0, "RBI": 11, "BB": 7, "SO": 19, "SB": 3, "CS": 1, "AVG": "0.302", "OBP": "0.380", "SLG": "0.317", "OPS": "0.697", "IBB": 0, "HBP": 1, "SAC": 0, "SF": 0, "TB": 20, "XBH": 1, "GDP": 1, "GO": 6, "AO": 12, "GO/AO": "0.50", "PA": 71, BABIP: '0.00', ISO: '0.10', 'AB/HR': '0.20', 'BB/K': '0.30', 'BB%': '0.40', 'SO%': '0.50'
        },
        {
    ...
    it('should transform a populated table to a string array with the statistic keys when a valid season is passed in', () => {
      ...
      const expectedStatisticKeys = ["#", "Player", "G", "AB", "R", "H", "2B", "3B", "HR", "RBI", "BB", "SO", "SB", "CS", "AVG", "OBP", "SLG", "OPS", "IBB", "HBP", "SAC", "SF", "TB", "XBH", "GDP", "GO", "AO", "GO/AO", "PA", 'BABIP', 'ISO', 'AB/HR', 'BB/K', 'BB%', 'SO%'];
